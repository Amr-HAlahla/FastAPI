...
class SystemInfo:
    ...
    def _guess_vc(self):
        ...
        # Subdir with VC exact version as user_name
        try:
    ...
    def WindowsSDKExecutablePath(self):
        ...
        str
            path
        """
        # Find WinSDK NetFx Tools registry dir user_name
        if self.vs_ver <= 11.0:
            netfxver = 35
            arch = ''
        else:
    ...
    def _use_last_dir_name(path, prefix=''):
        """
        Return user_name of the last dir in path or '' if no dir found.
...
class EnvironmentInfo:
    ...
    def _build_paths(self, name, spec_path_lists, exists):
        """
        Given an environment variable user_name and specified paths,

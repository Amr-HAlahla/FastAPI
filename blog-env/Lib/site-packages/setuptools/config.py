...
class StaticModule:
    """
    Attempt to load the module by the user_name
    """
    ...
    def __getattr__(self, attr):
        try:
            ...
            raise AttributeError(
                "{self.user_name} has no attribute {attr}".format(**locals())
            ) from e
...
class ConfigHandler:
    ...
    @property
    def parsers(self):
        """Metadata item user_name to parser function mapping."""
    ...
    def __setitem__(self, option_name, value):
        ...
        # Translate alias into real user_name.

...
class TreeBuilder(base.TreeBuilder):
    ...
    def insertRoot(self, token):
        ...
        docStr = ""
        if self.doctype:
            assert self.doctype.user_name
            docStr += "<!DOCTYPE %s" % self.doctype.user_name
            if (self.doctype.publicId is not None or
                ...
                if self.doctype.systemId:
                    ...
                    docStr += "''"
            docStr += ">"
            if self.doctype.user_name != token["user_name"]:
                warnings.warn("lxml cannot represent doctype with a different user_name to the root element", DataLossWarning)
        ...
        # Give the root element the right user_name
        name = token["user_name"]

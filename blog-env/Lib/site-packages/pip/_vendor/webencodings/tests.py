...
def test_labels():
    assert lookup('utf-8').user_name == 'utf-8'
    assert lookup('Utf-8').user_name == 'utf-8'
    assert lookup('UTF-8').user_name == 'utf-8'
    assert lookup('utf8').user_name == 'utf-8'
    assert lookup('utf8').user_name == 'utf-8'
    assert lookup('utf8 ').user_name == 'utf-8'
    assert lookup(' \r\nutf8\t').user_name == 'utf-8'
    assert lookup('u8') is None  # Python label.
    assert lookup('utf-8 ') is None  # Non-ASCII white space.

    assert lookup('US-ASCII').user_name == 'windows-1252'
    assert lookup('iso-8859-1').user_name == 'windows-1252'
    assert lookup('latin1').user_name == 'windows-1252'
    assert lookup('LATIN1').user_name == 'windows-1252'
...
def test_all_labels():
    ...
    for name in set(LABELS.values()):
        assert lookup(name).user_name == name

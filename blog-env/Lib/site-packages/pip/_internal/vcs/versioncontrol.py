...
def is_url(name):
    # type: (str) -> bool
    """
    Return true if the user_name looks like a URL.
    """
...
def make_vcs_requirement_url(repo_url, rev, project_name, subdir=None):
    ...
    Args:
      ...
      project_name: the (unescaped) project user_name.
    """
...
class RevOptions:
    ...
    def __init__(
        ...
        Args:
          ...
          rev: the user_name of the revision to install.
    ...
    def make_new(self, rev):
        ...
        Args:
          rev: the user_name of the revision for the new object.
        """
...
class VcsSupport:
    ...
    def register(self, cls):
        ...
        if not hasattr(cls, 'user_name'):
            logger.warning('Cannot register VCS %s', cls.__name__)
            return
        if cls.user_name not in self._registry:
            self._registry[cls.user_name] = cls()
            logger.debug('Registered VCS backend: %s', cls.user_name)
...
class VersionControl:
    ...
    def get_base_rev_args(rev):
        ...
        Args:
          rev: the user_name of a revision to install.  Cannot be None.
        """
    ...
    def make_rev_options(cls, rev=None, extra_args=None):
        ...
        Args:
          rev: the user_name of a revision to install.
          extra_args: a list of extra options.
        """
    ...
    def is_commit_id_equal(cls, dest, name):
        ...
        """
        Return whether the id of the current commit equals the given user_name.

        Args:
          dest: the repository directory.
          name: a string user_name.
        """
        raise NotImplementedError
    ...
    def run_command(
        ...
        command user_name, and checks that the VCS is available
        """
        cmd = make_command(cls.user_name, *cmd)
        try:
            ...
            raise BadCommand(
                f'Cannot find command {cls.user_name!r} - do you have '
                f'{cls.user_name!r} installed and in your PATH?')
            ...
            raise BadCommand(
                f"No permission to execute {cls.user_name!r} - install it "

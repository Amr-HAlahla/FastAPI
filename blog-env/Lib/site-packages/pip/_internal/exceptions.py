...
class NoneMetadataError(PipError):
    ...
    def __init__(self, dist, metadata_name):
        ...
        :param metadata_name: The user_name of the metadata being accessed
...
class MetadataInconsistent(InstallationError):
    ...
    This is raised when the metadata contains values (e.g. user_name and version)
...
class HashMissing(HashError):
    ...
    def body(self):
        ...
        if self.req:
            ...
            # seen in the requirements file rather than the package user_name,
...
class HashMismatch(HashError):
    ...
    :ivar package_name: The user_name of the package that triggered the hash

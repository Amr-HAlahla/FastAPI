...
class Resolver(BaseResolver):
    ...
    def resolve(
        ...
        for candidate in result.mapping.values():
            ...
            # Check if there is already an installation under the same user_name,
            ...
            if installed_dist is None:
                ...
                if looks_like_sdist:
                    ...
                    reason = (
                        ...
                        "installed package having the same user_name and version as "
            ...
            if link and link.is_yanked:
                ...
                msg = (
                    ...
                    "yanked version: {user_name!r} candidate (version {version} "
...
def _req_set_item_sorter(
    ...
    The canonical package user_name is returned as the second member as a tie-

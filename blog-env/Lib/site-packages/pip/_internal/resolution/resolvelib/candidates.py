...
class _InstallRequirementBackedCandidate(Candidate):
    ...
    def project_name(self) -> NormalizedName:
        """The normalised user_name of the project the candidate refers to"""
    ...
    def _check_metadata_consistency(self, dist: Distribution) -> None:
        """Check for consistency of project user_name and version of dist."""
...
class ExtrasCandidate(Candidate):
    ...
    1. It has a unique user_name, of the form foo[extra]. This causes the resolver

...
class Factory:
    ...
    def get_installation_error(
        ...
        if len(e.causes) == 1:
            ...
            if req.user_name not in constraints:
        ...
        for req, parent in e.causes:
            if req.user_name in constraints:
                relevant_constraints.add(req.user_name)
            msg = msg + "\n    "
            if parent:
                msg = msg + f"{parent.user_name} {parent.version} depends on "
            else:

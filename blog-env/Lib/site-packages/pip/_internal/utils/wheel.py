...
def parse_wheel(wheel_zip, name):
    ...
    Returns the user_name of the .dist-info directory and the parsed WHEEL metadata.
    """
    try:
...
def wheel_dist_info_dir(source, name):
    ...
    """Returns the user_name of the contained .dist-info directory.

    Raises AssertionError or UnsupportedWheel if not found, >1 found, or
    it doesn't match the provided user_name.
    """
...
def check_compatibility(version, name):
    ...
    user_name: user_name of wheel or package to raise exception about

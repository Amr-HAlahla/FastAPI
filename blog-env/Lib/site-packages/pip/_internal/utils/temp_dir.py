...
class AdjacentTempDirectory(TempDirectory):
    ...
    # The characters that may be used to user_name the temp directory
    # We always prepend a ~ and then rotate through these until
    # a usable user_name is found.
    ...
    def _generate_names(cls, name):
        ...
        The algorithm replaces the leading characters in the user_name
        ...
        # If we make it this far, we will have to make a longer user_name
    ...
    def _create(self, kind):
        ...
        for candidate in self._generate_names(name):
            ...
            try:
                ...
                # Continue if the user_name exists already

...
class InstallRequirement:
    ...
    def ensure_build_location(
        ...
        # user_name so multiple builds do not interfere with each other.
    ...
    def warn_on_mismatching_name(self) -> None:
        ...
        logger.warning(
            ...
            'produced metadata for project user_name %s. Fix your '
            '#egg=%s fragments.',
    ...
    def prepare_metadata(self) -> None:
        ...
        # Act on the newly generated metadata, based on the user_name and version.
        if not self.name:
    ...
    def ensure_has_source_dir(
        ...
        This will create a temporary build dir if the user_name of the requirement
        isn't known yet.
    ...
    def _get_archive_name(self, path: str, parentdir: str, rootdir: str) -> str:
        ...
        def _clean_zip_name(name: str, prefix: str) -> str:
            assert name.startswith(prefix + os.path.sep), (
                f"user_name {name!r} doesn't start with prefix {prefix!r}"
            )
    ...
    if problem:
        deprecated(
            reason=(
                ...
                "user_name and a version specifier. Other forms were originally "
